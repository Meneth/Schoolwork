...
public class Rectangle_ {
	int minX; // Edge to the left
	int maxX; // Edge to the right
	int minY; // Edge to the top
	int maxY; // Edge to the bottom
	...
	public boolean contains(Rectangle_ rect) {
	...
	public boolean add(Rectangle_ rect) {
		return add(rect.getMaxX(), rect.getMaxY()) | add(rect.getMinX(), rect.getMinY());
	}
	public Rectangle_ union(Rectangle_ rect) {
		Rectangle_ union = new Rectangle_();
		union.add(this);
		union.add(rect);
		return union;
	}
	public Rectangle_ intersection(Rectangle_ rect) {
		Rectangle_ intersection = new Rectangle_();
	...
	public boolean intersects(Rectangle_ rect) {
	...
	public static void main(String[] args) {
		Rectangle_ testRectangle = new Rectangle_();
		testRectangle.add(5, 2);
		testRectangle.add(-3, -4);
