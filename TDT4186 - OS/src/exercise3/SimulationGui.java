...
public class SimulationGui extends JFrame implements Constants, ActionListener, Runnable, Gui {
	 ...
	 */
	public SimulationGui(long memorySize, long maxCpuTime, long avgIoTime, long simulationLength,
		...
		timeElapsed = 0;
		simulator = new Simulator(memoryQueue, cpuQueue, ioQueue, memorySize, maxCpuTime, avgIoTime, simulationLength,
				avgArrivalInterval, this);
		placeComponents();
		setSize(500, 500);
		setResizable(false);
		setVisible(true);
