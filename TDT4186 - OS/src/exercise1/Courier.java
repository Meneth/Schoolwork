...
public class Courier extends Thread {
	...
	/**
	 * Visit the bank nofVisits times, and each time deposit between 50 and 149
	 * dollars. Keep records of how much we have deposited, as the bank has been
	 * known to keep faulty records.
	 */
	public void run() {
		for (int i = 0; i < nofVisits; i++) {
			int amount = 50 + (int) (Math.random() * 100);
